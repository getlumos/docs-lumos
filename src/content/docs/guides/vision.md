---
title: LUMOS Vision - The Workflow Language for Solana
...
**For horizontal expansion plans**: See [FUTURE](/guides/future)
...
**For what comes after ENDGAME**: See [FUTURE](/guides/future)
...
See the [LUMOS GitHub repository](https://github.com/getlumos/lumos) for detailed phases and issues.
...
See [FUTURE](/guides/future) for detailed horizontal expansion plans (Phase 10-13).

---

**Related Documents:**
- [Quick Start](/getting-started/quick-start) - Getting started with LUMOS
- [FUTURE](/guides/future) - Horizontal expansion (Phase 10+)
- [LUMOS GitHub](https://github.com/getlumos/lumos) - Main repository
